...
public class ConceptoGastos  implements java.io.Serializable {
    ...
    public ConceptoGastos(int id) {
        this.id = id;
    }
    public ConceptoGastos(int id, String descripcion, String uuid, BigDecimal precioUnitario, String cantidad, String unidad, String claveUnidad, BigDecimal importe, String claveProd) {
       this.id = id;
